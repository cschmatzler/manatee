...
from manatee.crud.user import read_user_by_id
...
def test_read_invalid_user():
    for i in range(0, 20):
        id = uuid.uuid4()
        assert not read_user_by_id(UUID("08dfdc7a-511f-4ff5-8eb9-cff3730d0357"), id)


def test_read_existing_user_with_invalid_organization():
    assert not read_user_by_id(
        UUID("08dfdc7a-511f-4ff5-8eb9-000000000000"),
        UUID("a3b44076-4220-4e68-9388-112439ccb6f8"),
    )
